...
void HW_dac_init(void)
{
	...
	GpioCtrlRegs.GPAPUD.bit.GPIO24 = 1;     							/* Disable pull-up on GPIO20 (MDXA) */
	GpioCtrlRegs.GPAPUD.bit.GPIO26 = 0;     							/* Enable pull-up on GPIO22 (MCLKXA) */
	GpioCtrlRegs.GPAPUD.bit.GPIO27 = 0;     							/* Enable pull-up on GPIO23 (MFSXA) */

    /* Configure GPIO 21 as output for LDAC signal */
    GpioCtrlRegs.GPAMUX2.bit.GPIO25 = 0;    							/* As GPIO */
    GpioCtrlRegs.GPADIR.bit.GPIO25 = 1;     							/* As output */
    GpioCtrlRegs.GPAPUD.bit.GPIO25 = 1;     							/* Disable pull-up */
    GpioDataRegs.GPACLEAR.bit.GPIO25 = 1;								/* Initial output is low */
